...
public class DetailDiajarinKerja extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_diajarinkerja);
        ...
        GridLayoutManager gridLayoutTips= new GridLayoutManager(DetailDiajarinKerja.this, 1 );
            ...
            protected void onBindViewHolder(@NonNull TipsViewHolder holder, int position, @NonNull final Tips model) {
                holder.bindToCard(model, new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(DetailDiajarinKerja.this, VideoPlayerActivity.class);
    ...
    private Query getQueryTes(DatabaseReference mDatabase){
        Query tes = mDatabase.child("DiajariKerja").child(String.valueOf(id)).child("video");
        return tes;
    }
