...
public class DiajarinTesTips extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_diajarintes_tips);
        ...
        GridLayoutManager gridLayoutTips= new GridLayoutManager(DiajarinTesTips.this, 1 );
            ...
            protected void onBindViewHolder(@NonNull TipsViewHolder holder, int position, @NonNull final Tips model) {
                holder.bindToCard(model, new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(DiajarinTesTips.this, VideoPlayerActivity.class);
    ...
    private Query getQueryTes(DatabaseReference mDatabase){
        Query tes = mDatabase.child("TesDetail").child(String.valueOf(id)).child("videotips");
        return tes;
    }
